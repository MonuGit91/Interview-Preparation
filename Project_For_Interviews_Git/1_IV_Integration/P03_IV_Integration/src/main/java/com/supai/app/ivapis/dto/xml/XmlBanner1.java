...
public class XmlBanner1 {
    ...
    public static class PublishBanners {
        ...
        private StringValue fontHeight = new StringValue("12");

        @JacksonXmlProperty(localName = "IsoBannerColor")
        private StringValue color = new StringValue("0,0,225");

        @JacksonXmlProperty(localName = "TopCenter")
        private StringValue topCenter;

        @JacksonXmlProperty(localName = "BottomLeft")
        private StringValue bottomLeft;

        @JacksonXmlProperty(localName = "BottomCenter")
        private StringValue bottomCenter;
