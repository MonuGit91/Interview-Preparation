...
//            System.out.println("Exception in domainExtract in CrawlerApplication");
    ...
    public static String[] filterQuarry(String quarry) {
        String arr[] = splitIntoArrayOfWords(quarry);
...
//        }
//
//        words = new String[conut];
//        for(int i = 0, j = 0; i < arr.length; i++) {
//            if(arr[i].length() > 2) words[j++] = arr[i].toLowerCase();
//        }

        return words = arr;
    }

    public static String[] splitIntoArrayOfWords(String str) {
